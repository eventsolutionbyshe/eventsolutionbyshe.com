...
$sql = "
    ...
    SELECT
        ...
        CONVERT(
            b.special_requests USING utf8mb4
        )
        COLLATE utf8mb4_unicode_ci
        AS special_requests,
...
<link
    rel="stylesheet"
    href="admin.css/admin_bookings.css"
>
        ...
        <table class="bookings-table">
            ...
            <?php if (!empty($bookings)): ?>
                ...
                <?php foreach (
                     ...
                     *
                     * This is kept at 1 when a
                     * guest-list link is generated.
                     */
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php if (
                                ...
                                <a
                                    href="admin_guestlist.php?token=<?= urlencode(
                                        $token
                                    ); ?>"
...
<script src="admin.js/admin_bookings.js"></script>
